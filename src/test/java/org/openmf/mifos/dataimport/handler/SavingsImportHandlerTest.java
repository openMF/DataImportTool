...
public class SavingsImportHandlerTest {
    ...
    public void shouldParseSavingsAccount() throws IOException {
        ...
        Assert.assertEquals(2, handler.getSavings().size());
        Assert.assertEquals(2, handler.getApprovalDates().size());
        Assert.assertEquals(2, handler.getActivationDates().size());
        ...
        GroupSavingsAccount groupSavings = (GroupSavingsAccount)handler.getSavings().get(1);
        Assert.assertEquals("1", groupSavings.getGroupId());
