...
public class GroupWorkbookPopulatorTest {
    ...
    public void shouldPopulateGroupWorkbook() {
    	...
    	Assert.assertEquals("Meeting Start Date* (On or After)", row.getCell(7).getStringCellValue());
    	Assert.assertEquals("Repeat*", row.getCell(8).getStringCellValue());
    	Assert.assertEquals("Frequency*", row.getCell(9).getStringCellValue());
    	Assert.assertEquals("Interval*", row.getCell(10).getStringCellValue());
    	Assert.assertEquals("Repeats On*", row.getCell(11).getStringCellValue());
    	Assert.assertEquals("Client Names* (Enter in consecutive cells horizontally)", row.getCell(15).getStringCellValue());
