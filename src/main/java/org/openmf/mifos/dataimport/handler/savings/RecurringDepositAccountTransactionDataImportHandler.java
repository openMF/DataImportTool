...
public class RecurringDepositAccountTransactionDataImportHandler extends AbstractDataImportHandler {

	private static final Logger logger = LoggerFactory.getLogger(RecurringDepositAccountTransactionDataImportHandler.class);
    ...
    public RecurringDepositAccountTransactionDataImportHandler(Workbook workbook, RestClient client) {
    ...
    public Result upload() {
        ...
        for (Transaction transaction : savingsTransactions) {
            try {
                ...
                restClient.post("recurringdepositaccounts/" + transaction.getAccountId() + "/transactions?command=" + transaction.getTransactionType(), payload);
