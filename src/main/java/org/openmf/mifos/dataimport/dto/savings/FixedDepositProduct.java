...
public class FixedDepositProduct {
    ...
    public FixedDepositProduct(Integer id, String name, String shortName, Currency currency, Double nominalAnnualInterestRate,
            ...
            Type inMultiplesOfDepositTermType) {
        this.id = id;
        this.name = name;
