...
public class Loan {
    ...
    private final String fixedEmiAmount;

    private final String maxOutstandingLoanBalance;

    private final List<EmiDetail> disbursementData;

    public Loan(String loanType, String clientId, String productId, String loanOfficerId, String submittedOnDate, String fundId,
            ...
            String repaymentsStartingFromDate, Integer rowIndex, String status, String externalId, String fixedEmiAmount,
            String maxOutstandingLoanBalance, List<EmiDetail> disbursementData) {
    ...
    public String getFixedEmiAmount() {
        return this.fixedEmiAmount;
    }

    public String getMaxOutstandingLoanBalance() {
        return this.maxOutstandingLoanBalance;
    }

    public List<EmiDetail> getDisbursementData() {
